	...
	var initDataTables = function() {
		if ($.fn.dataTable) {
			...
			$('.datatable').each(function () {
				...
				// Default order
				var data_defaultOrder = self.data('defaultOrder');
				console.log ('data_defaultOrder: ' + data_defaultOrder + ' ' + self.attr('class') + ' data: ' + self.data('displayLength'));
				if (typeof data_defaultOrder != 'undefined') {
					$.extend(true, options, {
						"aaSorting": [[ data_defaultOrder, "desc" ]],
						"bSort": true
					});
				}				
